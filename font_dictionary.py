# only modify this file if you feel your CSV file needs a special font
# if you do, make sure to add that font to the `fonts` folder
...
fonts = {
    ...
    "spanish": "fonts/Courgette/Courgette-Regular.ttf",
}
